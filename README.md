...
## Supported WiFi hardware:
 ...
 - **Atheros AR9350** (ath9k SoC). (stable) 802.11n (2.4GHz and/or 5GHz bands) + LDPC capable. Work out of box, but requires kernel patches **to control TX power** (by default it will use max power). System was tested with [TP-Link CPE510](https://openwrt.org/toh/tp-link/cpe510), but should work with all similar devices on this chipset (Ubiquiti, etc)`.
